        ...
        >
          <MenuItems className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-[var(--primary)] shadow-lg ring-1 ring-[var(--primary)] ring-opacity-5 focus:outline-none divide-y divide-white">
            <div className="px-4 py-3">
              ...
              {displayEmail && (
                <p className="text-xs text-gray-300">{displayEmail}</p>
              )}
              {!displayEmail && (
            ...
            <ul className="py-1">
              <li>
                ...
                >
                  ...
                  {user?.wallet?.address && !displayEmail
                    ? "Disconnect Wallet"
                    : "Sign out"}
                </button>
              </li>
      ...
      {isWithdrawModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
            ...
            <div className="relative inline-block align-bottom bg-[var(--primary)] rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
